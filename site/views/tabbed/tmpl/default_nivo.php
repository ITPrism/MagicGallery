            ...
            foreach ($this->galleries[$item->id] as $gallery) {
                ...
                <?php if ($defaultResource->getThumbnail()) { ?>
                    <div class="col-xs-6 col-md-4">
                        <a href="<?php echo $this->mediaUrl . "/" . $defaultResource->getImage(); ?>" <?php echo $this->openLink; ?> class="thumbnail mt-10 <?php echo $this->modalClass; ?>" data-lightbox-gallery="js-com-tabbed-nivo<?php echo $item->id;?>">
