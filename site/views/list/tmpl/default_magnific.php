    ...
    <div class="row">
        <?php if ($defaultImage) { ?>
            <div class="col-md-3" style="width: <?php echo $this->params->get('thumb_width', 200); ?>; height: <?php echo $this->params->get('thumb_height', 200); ?>;">
                ...
                <a href="<?php echo $this->mediaUrl . '/'. $defaultImage['image']; ?>" <?php echo $this->openLink; ?> class="<?php echo $this->modalClass;?>" rel="group<?php echo $item->id;?>">
                    <?php } ?>
                    <img
                ...
                <?php if ($this->params->get('display_additional_images', 0) and !empty($images)) {?>
                    <div class="mg-additional-images">
                        ...
                        foreach ($images as $image) {
                            ?>
                            <a href="<?php echo $this->mediaUrl . '/'. $image['image'];?>" <?php echo $this->openLink;?> class="<?php echo $this->modalClass;?>" rel="group<?php echo $item->id;?>">
                                <img
